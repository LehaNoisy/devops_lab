...
parser.add_argument("--pswd", help="that optional takes your github account",
                    required=True)
parser.add_argument("--login", help="that optional takes your github login",
                    required=True)
parser.add_argument("--repos", nargs="?",
                    help="that optional arghas:\n \"rep_name\" and \"id_rep\"")
string1 = "opt arg:\n \"pull_title\" "
string1 += "and \"pull_id\" and \"pull_updated\""
string1 += " and \"user\""
parser.add_argument(
              "--pulls", nargs="?",
              help=string1
...
if args.pulls == "rep_title":
    ...
    for i in range(max_count):
        print(str(json.dumps(json_pulls[i]["title"],
...
if args.pulls == "pull_id":
    ...
    i = 0
    for i in range(max_count):
        print(str(json.dumps(json_pulls[i]["id"], sort_keys=True, indent=4,
                  ensure_ascii=False)))
...
if args.pulls == "rep_updated":
    ...
    i = 0
    for i in range(max_count):
        print(str(json.dumps(json_pulls[i]["updated_at"], sort_keys=True,
